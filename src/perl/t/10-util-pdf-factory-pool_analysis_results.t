...

{
  ...
  my $input_table_result = [['Plate name','Barcode'],['0123456','6250354579651']];
...
DDD_V5_plus'
  ...
  is_deeply($factory->_format($factory->plate_style_table, $table_info->{'plate_table_data'}), $table_style);
