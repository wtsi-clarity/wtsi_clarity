...
{ # _get_containers_data
  ...
  my $step = wtsi_clarity::epp::sm::worksheet->new(
    process_url => 'http://clarity-ap:8080/api/v2/processes/24-103755');
  ...
  foreach my $datum (@expected_data) {
    ...
    cmp_ok($in_type,'eq', $exp_typ, "_get_containers_data(...) should give the container type. ");
  }
}
