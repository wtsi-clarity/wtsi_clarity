...
{
  local $ENV{'WTSICLARITY_WEBCACHE_DIR'} = 't/data/sm/bed_verification/working_dilution/';
...
{
  local $ENV{'WTSICLARITY_WEBCACHE_DIR'} = 't/data/sm/bed_verification/pico_green/';
  local $ENV{'SAVE2WTSICLARITY_WEBCACHE'} = 1;
