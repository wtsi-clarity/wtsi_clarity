...
use_ok('wtsi_clarity::epp::isc::pooling::pool_placer', 'can use ISC pool placer');

my $placer = wtsi_clarity::epp::isc::pooling::pool_placer->new(
  process_url => $base_uri . '/processes/122-22172',
  step_url => $base_uri . '/steps/122-22172',
);

isa_ok( $placer, 'wtsi_clarity::epp::isc::pooling::pool_placer');
