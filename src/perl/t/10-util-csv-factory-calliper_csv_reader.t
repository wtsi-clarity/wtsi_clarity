...

{
  ...
  throws_ok{
    $reader->build()
  } qr/Requires headers!/, "Requires headers";
  throws_ok{
    $reader->build(("headers" => "header"))
  } qr/Requires a file content!/, "Requires a file content";
  throws_ok{
    $reader->build(("headers" => "header", "file_content" => "content"))
  } qr/Requires the barcode of the original plate!/, "Requires the barcode of the original plate";
}
