...
use_ok('wtsi_clarity::epp::sm::cherrypick_bed_verifier');

{
  local $ENV{'WTSICLARITY_WEBCACHE_DIR'} = 't/data/epp/sm/cherrypick_bed_verifier/';
  local $ENV{'SAVE2WTSICLARITY_WEBCACHE'} = 1;

  my $process = wtsi_clarity::epp::sm::cherrypick_bed_verifier->new(
...
# File input_output
{
  ...
  my $process = wtsi_clarity::epp::sm::cherrypick_bed_verifier->new(
    process_url => $base_uri . '/processes/24-104741',
    _tecan_file => 't/data/epp/sm/cherrypick_bed_verifier/tecan.gwl',
  );
