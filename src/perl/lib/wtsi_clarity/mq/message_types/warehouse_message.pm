package wtsi_clarity::mq::message_types::warehouse_message;
...
enum 'WtsiClarityMqWarehousePurpose', [qw( sample study user fluidigm flowcell )];

has 'purpose' => (
  isa      => 'WtsiClarityMqWarehousePurpose',
  is       => 'ro',
  required => 1,
);
...
wtsi_clarity::mq::message_types::warehouse_message

=head1 SYNOPSIS

  my $m = wtsi_clarity::mq::message_types::warehouse_message->new(
      process_url => 'some',
      step_url    => 'other',
      step_start  => 1,
