package wtsi_clarity::epp::generic::plate_purpose_updater;
...
wtsi_clarity::epp::generic::plate_purpose_updater

=head1 SYNOPSIS

  wtsi_clarity::epp:sm::plate_purpose_updater->new(process_url => 'http://my.com/processes/3345')->run();
