...
wtsi_clarity::epp::sm::dtx_file_attacher

=head1 SYNOPSIS

  use wtsi_clarity::epp::sm::dtx_file_attacher;
  wtsi_clarity::epp::sm::dtx_file_attacher->new(process_url => 'http://some.com/process/1234XM')->run();
