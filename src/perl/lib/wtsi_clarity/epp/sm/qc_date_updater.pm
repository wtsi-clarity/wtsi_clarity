package wtsi_clarity::epp::sm::qc_date_updater;
...
wtsi_clarity::epp::sm::qc_date_updater

=head1 SYNOPSIS

  wtsi_clarity::epp:sm::qc_date_updater->new(process_url => 'http://my.com/processes/3345')->run();
