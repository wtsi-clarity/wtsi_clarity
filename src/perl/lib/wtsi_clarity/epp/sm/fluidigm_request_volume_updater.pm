package wtsi_clarity::epp::sm::fluidigm_request_volume_updater;
...
wtsi_clarity::epp::sm::fluidigm_request_volume_updater

=head1 SYNOPSIS

  wtsi_clarity::epp:sm::fluidigm_request_volume_updater->new(process_url => 'http://my.com/processes/3345')->run();
